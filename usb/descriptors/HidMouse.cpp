...
const ::usb::UsbDeviceDescriptor_t usbDeviceDescriptor FIXED_DATA = {
 ...
 ******************************************************************************/
static constexpr ::usb::UsbLangId_t usbSupportedLanguageIds[] FIXED_DATA = { 0x0409, 0x0000 };
...
static const auto usbStringDescriptorSerialNumber   FIXED_DATA  = ::usb::UsbStringDescriptor(u"3FA46E99-D84D-47F5-88A5-32D265AA4BBC");
static const auto usbStringDescriptorProduct        FIXED_DATA  = ::usb::UsbStringDescriptor(u"HID Demo on " STM32_BOARD " with " STM32_CPU_TYPE);
...
const ::usb::UsbStringDescriptors_t usbStringDescriptors FIXED_DATA = {
    .m_strings = {
 ...
 */
const uint8_t hidMouseReportDescriptor[50] FIXED_DATA = {
    0x05,   0x01,
    0x09,   0x02,
    0xA1,   0x01,
    0x09,   0x01,
...
static const struct UsbHidMousConfigurationDescriptor_s {
...
} __attribute__((packed)) usbHidMouseConfigurationDescriptor FIXED_DATA = {
    .m_configDescrHdr = {
        .m_bLength                  = sizeof( decltype(usbHidMouseConfigurationDescriptor.m_configDescrHdr)),
        .m_bDescriptorType          = ::usb::UsbDescriptorTypeId_e::e_Configuration,
        .m_wTotalLength = {
            .m_loByte               = (sizeof(decltype(usbHidMouseConfigurationDescriptor)) >> 0),
            .m_hiByte               = (sizeof(decltype(usbHidMouseConfigurationDescriptor)) >> 8)
        },
        .m_bNumInterfaces           = 1,
    ...
    .m_hidInterface = {
        .m_bLength                  = sizeof(decltype(usbHidMouseConfigurationDescriptor.m_hidInterface)),
    ...
    .m_hidDescriptor = {
        .m_bLength                  = sizeof(decltype(usbHidMouseConfigurationDescriptor.m_hidDescriptor)),
    ...
    .m_hidEndpoint = {
        .m_bLength                  = sizeof(decltype(usbHidMouseConfigurationDescriptor.m_hidEndpoint)),
...
const ::usb::UsbConfigurationDescriptor_t * const usbConfigurationDescriptor FIXED_DATA = reinterpret_cast<const ::usb::UsbConfigurationDescriptor_t *>(&usbHidMouseConfigurationDescriptor);
