...
static const auto usbStringDescriptorProduct        FIXED_DATA  = ::usb::UsbStringDescriptor(u"Virtual COM Port (VCP) on " STM32_BOARD " with " STM32_CPU_TYPE);
...
extern const struct UsbConfigurationDescriptor_s {
...
} __attribute__((packed)) usbVcpConfigurationDescriptor FIXED_DATA = {
    .m_configDescrHdr = {
        .m_bLength                  = sizeof( decltype(usbVcpConfigurationDescriptor.m_configDescrHdr)),
        .m_bDescriptorType          = ::usb::UsbDescriptorTypeId_e::e_Configuration,
        .m_wTotalLength = {
            .m_loByte               = (sizeof(decltype(usbVcpConfigurationDescriptor)) >> 0),
            .m_hiByte               = (sizeof(decltype(usbVcpConfigurationDescriptor)) >> 8)
        },
        .m_bNumInterfaces           = 2,
    ...
    .m_iad = {
        .m_bLength                  = sizeof(decltype(usbVcpConfigurationDescriptor.m_iad)),
    ...
    .m_cdcInterface = {
        .m_bLength                  = sizeof(decltype(usbVcpConfigurationDescriptor.m_cdcInterface)),
    ...
    .m_cdcFunctDescr_Header = {
        .m_cdcFncDescr = {
            .m_bFunctionLength      = sizeof(decltype(usbVcpConfigurationDescriptor.m_cdcFunctDescr_Header)),
    ...
    .m_cdcFunctDescr_CallMgmt = {
        .m_cdcFncDescr = {
            .m_bFunctionLength      = sizeof(decltype(usbVcpConfigurationDescriptor.m_cdcFunctDescr_CallMgmt)),
            .m_bDescriptorType      = ::usb::UsbCdcFunctionalDescriptorType_e::e_UsbDec_DescrType_Interface,
            .m_bDescriptorSubtype   = ::usb::UsbCdcFunctionalDescriptorSubtype_e::e_UsbDec_DescrSubtype_CallMgmt
        },
        .m_bmCapabilities           = 0,
        .m_bDataInterface           = 1 /* usbVcpConfigurationDescriptor.m_dataInterface.m_bInterfaceNumber */
    },
    .m_cdcFunctDescr_ACM = {
        .m_cdcFncDescr = {
            .m_bFunctionLength      = sizeof(decltype(usbVcpConfigurationDescriptor.m_cdcFunctDescr_ACM)),
            .m_bDescriptorType      = ::usb::UsbCdcFunctionalDescriptorType_e::e_UsbDec_DescrType_Interface,
    ...
    .m_cdcFunctDescr_Union = {
        .m_cdcFncDescr = {
            .m_bFunctionLength      = sizeof(decltype(usbVcpConfigurationDescriptor.m_cdcFunctDescr_Union)),
            .m_bDescriptorType      = ::usb::UsbCdcFunctionalDescriptorType_e::e_UsbDec_DescrType_Interface,
            .m_bDescriptorSubtype   = ::usb::UsbCdcFunctionalDescriptorSubtype_e::e_UsbDec_DescrSubtype_Union
        },
        .m_bControlInterface        = 0 /* usbVcpConfigurationDescriptor.m_cdcInterface.m_bInterfaceNumber */,
        .m_subordinateInterface     = {
            1 /* usbVcpConfigurationDescriptor.m_dataInterface.m_bInterfaceNumber */
        }
    },
    .m_notificationEndpoint = {
        .m_bLength                  = sizeof(decltype(usbVcpConfigurationDescriptor.m_notificationEndpoint)),
    ...
    .m_dataInterface = {
        .m_bLength                  = sizeof(decltype(usbVcpConfigurationDescriptor.m_dataInterface)) - sizeof(usbVcpConfigurationDescriptor.m_dataInterface.m_endpoints),
        .m_bDescriptorType          = ::usb::UsbDescriptorTypeId_e::e_Interface,
        ...
        .m_endpoints                = {
            /* Index #0 */ {
                .m_bLength          = sizeof(decltype(usbVcpConfigurationDescriptor.m_dataInterface.m_endpoints[0])),
                .m_bDescriptorType  = ::usb::UsbDescriptorTypeId_e::e_Endpoint,
            ...
            /* Index #1 */ {
                .m_bLength          = sizeof(decltype(usbVcpConfigurationDescriptor.m_dataInterface.m_endpoints[1])),
                .m_bDescriptorType  = ::usb::UsbDescriptorTypeId_e::e_Endpoint,
...
const ::usb::UsbConfigurationDescriptor_t * const usbConfigurationDescriptor FIXED_DATA = reinterpret_cast<const ::usb::UsbConfigurationDescriptor_t *>(&usbVcpConfigurationDescriptor);
